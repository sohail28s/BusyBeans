...
const TopProductsReport = () => {
    ...
    useEffect(() => {
        const fetchReportData = async () => {
            ...
            try {
                ...
                const url = `https://testingbb.trimworldwide.com/api/v1/admin/supplier-reports/top-products-ordered-report/${userId}`;
    ...
    const handleDownloadCSV = () => {
        ...
        const csvFormatted = displayData.map(row => ({
            ...
            "Total Dispatched Items": row.dispatchedItems || "0",
            
        }));
        exportToCSV(csvFormatted, `Top_Products_Report_${startDate}_to_${endDate}.csv`);
    };
                        ...
                        <table className="w-full text-left border-none min-w-[900px]">
                            <thead className="bg-[#f9fafb]">
                                <tr>
                                    ...
                                    <th className="px-6 py-5 font-bold text-[#374151] text-[14px] w-[250px] border-none">Total Dispatched Items</th>
