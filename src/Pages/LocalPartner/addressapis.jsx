...
const LocalPartnerDetails = () => { 
    ...
    // ADDED: State to track if we are dealing with a shipping or billing address
    ...
    // FIXED: Now accepts the 'type' (shipping or billing) to pass to the modal
    ...
    return ( 
        <div className="w-full min-h-[calc(100vh-100px)] bg-white p-6 lg:p-8 font-sans flex justify-center items-start "> 
            ...
            {/* FIXED: Only one modal rendered, utilizing the states properly */}
            <AddressModal 
