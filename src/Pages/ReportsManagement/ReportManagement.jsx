...
export const ReportManagement = () => {
    ...
    // --- Report Data Array ---
    const reports = [
        { title: 'Partner Profits Report', path: '/reports/partner-commission', icon: <ClipboardChartIcon /> },
        { title: 'Partner Credit Limit Report', path: '/reports/partner-credit-limit', icon: <ClipboardChartIcon /> },
        { title: 'Unpaid Partner Balances Report', path: '/reports/unpaid-partner-balances', icon: <DocumentListIcon /> },
        { title: 'Products Sale Report', path: '/reports/products-sale', icon: <DocumentListIcon /> },
        { title: 'Customers Report', path: '/reports/customer', icon: <ClipboardChartIcon /> },
        { title: 'Direct Partner Report', path: '/reports/direct-partner', icon: <ClipboardChartIcon /> },
        { title: 'Sales by Customer Summary Report', path: '/reports/sales-by-customer-summary', icon: <ClipboardChartIcon /> },
        { title: 'Sales by Customer Details', path: '/reports/sales-by-customer-details', icon: <ClipboardChartIcon /> },
        { title: 'Product wise sales summary', path: '/reports/product-wise-sales-summary', icon: <ClipboardChartIcon /> },
        { title: 'Pulled Orders Receivable Report', path: '/reports/pulled-orders-receivable', icon: <DocumentListIcon /> },
    ];
