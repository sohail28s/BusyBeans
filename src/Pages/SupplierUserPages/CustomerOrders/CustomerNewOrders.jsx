...
const SupplierCustomerNewOrders = () => { 
    ...
    return ( 
        <SupplierCustomerOrderLayout 
            apiEndpoint={`https://testingbb.trimworldwide.com/api/v1/admin/orders?supplierId=${userId}&statusId=2`} 
            detailsBaseRoute="/supplier/order-detail/" 
        /> 
    ); 
}; 

export default SupplierCustomerNewOrders;